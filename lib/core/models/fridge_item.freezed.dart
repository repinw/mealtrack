...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,entryDate,storeName,quantity,initialQuantity,unitPrice,weight,const DeepCollectionEquality().hash(consumptionEvents),receiptId,receiptDate,language,brand,const DeepCollectionEquality().hash(discounts),isDeposit,isDiscount,isArchived);
...
switch (_that) {
case _FridgeItem() when $default != null:
return $default(_that.id,_that.name,_that.entryDate,_that.storeName,_that.quantity,_that.initialQuantity,_that.unitPrice,_that.weight,_that.consumptionEvents,_that.receiptId,_that.receiptDate,_that.language,_that.brand,_that.discounts,_that.isDeposit,_that.isDiscount,_that.isArchived);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,entryDate,storeName,quantity,initialQuantity,unitPrice,weight,const DeepCollectionEquality().hash(_consumptionEvents),receiptId,receiptDate,language,brand,const DeepCollectionEquality().hash(_discounts),isDeposit,isDiscount,isArchived);
